...
import ActionDefultCardProduct from "./ActionDefultCardProduct";

function DefultCardProduct({ product, badgecolor }) {
  return (
    <div className="h-full flex flex-col relative rounded-md bg-background border border-border shadow-sm hover:shadow-lg transition-all overflow-hidden">
      ...
      <ActionDefultCardProduct product={product} />
    </div>
  );
}

export default DefultCardProduct;
