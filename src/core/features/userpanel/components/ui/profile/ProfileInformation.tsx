    ...
    <>
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
        <div className="relative shrink-0">
          <div
            className="relative w-18 h-18 sm:w-28 sm:h-28 md:w-20 md:h-20 
rounded-full overflow-hidden border-2 border-border shadow-sm"
          >
            {user.image ? (
              <Image
                src={user.image}
              ...
              <div
                className="w-full h-full bg-linear-to-r from-primary/20 to-accent/20
text-primary flex items-center justify-center"
        ...
        <div className="flex-1 min-w-0">
          ...
          <TypographyMuted className="text-muted-foreground text-sm sm:text-base mt-0.5">
            {user.email}
          </TypographyMuted>

          <span className="inline-block mt-2 px-3 py-1 bg-muted text-muted-foreground text-xs sm:text-sm font-medium rounded-full">
            {user.role}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <TypographyMuted className="text-xs sm:text-sm text-muted-foreground">
                Phone
              </TypographyMuted>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-medium text-foreground-foreground text-sm sm:text-base">
                {user.gender || "Not set"}
              </p>
            </div>
          </div>
